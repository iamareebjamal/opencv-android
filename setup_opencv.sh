...
if [[ $1 = "--skip-download" ]]; then
    ...
    download_url="https://pullrequest.opencv.org/buildbot/export/opencv_releases/master-contrib_pack-contrib-android/20191222-054115--11020/OpenCV4Android.zip"
